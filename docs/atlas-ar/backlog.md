...
| **SEO-2** | **SEO Phase 2** — prerender shells for `/` `/pricing` `/about` legal; content hub; optional marketing host split; per-page OG | P2 | Marketing/Eng | **partial** · Batch 1 shells live ✅ · Batch 2/2b per-route OG JPEGs ✅ · hub / host-split still todo |
