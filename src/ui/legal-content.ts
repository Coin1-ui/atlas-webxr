  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Paid plans, trials, overage, and enterprise orders are described on our pricing page or in an order form. Unless an order form states otherwise, published Starter, Launch, and Growth plan prices include applicable taxes. Checkout and invoices may show the tax portion broken out from that total. Base subscription fees are billed in advance for each billing period. Usage overage (sessions, models, and storage beyond included amounts) is billed with your subscription payment cycle when usage meters exceed included thresholds, and is non-refundable except where required by law.",
