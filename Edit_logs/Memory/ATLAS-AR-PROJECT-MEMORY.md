...
| 2026-07-31 | **Contact emails cutover.** SoT `src/shared/contact.ts`: **support@atlasar.in** · **sales@atlasar.in**. About dual mailto; Learn + PRICING-FEATURE-READINESS + LEAD-SHEET + SAL-2 updated. Legal @atlas-ar.com unchanged. **User:** ensure mailboxes/DNS forward live. |
