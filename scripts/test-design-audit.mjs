...
const checks = [
  ...
  ["hero cinema video", read("src/ui/marketing-landing.ts").includes("mountHeroVideo") && read("src/ui/hero-video.ts").includes("home-hero.mp4")],
  ["hero self-hosted media", read("src/ui/hero-video.ts").includes("marketing/home-hero.mp4") && read("src/ui/hero-video.ts").includes("home-hero-poster.jpg")],
